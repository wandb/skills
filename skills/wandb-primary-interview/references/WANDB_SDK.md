...
> **AGENT**: This document uses placeholder names like `<primary_loss_key>`. Always substitute the actual values from the **Configuration table in SKILL.md**. If Configuration is not yet populated, complete the interview first (`references/INTERVIEW.md`).
